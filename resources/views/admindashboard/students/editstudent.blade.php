                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <form class="forms-sample" action="/admin/students/{{$item->id}}" method="POST">
                            @csrf
                            @method('PUT')
                          <div class="form-group">
                            <label for="exampleInputName1">Title</label>
                            <textarea type="textarea" class="form-control" id="name" name="name" placeholder="Name">{{$item->name}}</textarea>
                          </div>
                          <div class="form-group">
