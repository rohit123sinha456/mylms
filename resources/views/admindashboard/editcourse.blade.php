                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <form class="forms-sample" action="/admin/editcourse/{{$item->id}}" method="POST">
                            @csrf
                          ...
                          <div class="form-group">
                            ...
                            <input type="textarea" class="form-control" id="desc" name="desc" placeholder="Description" value={{$item->description}}>
                          </div>
